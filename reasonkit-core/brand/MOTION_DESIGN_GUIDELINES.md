...
1. **Snap-to-Grid** - UI elements _snap_ into place like machinery, not fade
...
**Purpose:** Elements should _snap_ into place like industrial machinery, not smoothly ease.
